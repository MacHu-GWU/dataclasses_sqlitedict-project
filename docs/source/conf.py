# -*- coding: utf-8 -*-
#
# dataclasses_sqlitedict documentation build configuration file, created by
...
import dataclasses_sqlitedict as package
...
# Add data for Jinja2
try:
    from dataclasses_sqlitedict.docs import doc_data
except:
    doc_data = dict()
